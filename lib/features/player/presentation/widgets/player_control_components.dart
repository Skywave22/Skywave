...
/// Frosted-glass circular button used for the touch-center skip-10 controls
/// in the "glassmorphic glow" player redesign. A translucent white fill with
/// a thin border reads clearly over any video without competing with the
/// primary gradient play/pause button.
class GlassSeekButton extends StatelessWidget {
  final IconData icon;
  final VoidCallback? onPressed;
  final double size;

  const GlassSeekButton({
    super.key,
    required this.icon,
    required this.onPressed,
    this.size = 52,
    ...
    return CustomButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: HotstarPlayerStyle.glassFill,
          border: Border.all(color: HotstarPlayerStyle.glassBorder, width: 1),
        ),
