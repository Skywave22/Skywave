...
import '../../features/settings/presentation/customize_home_screen.dart';
      ...
      routes: [
        TypedGoRoute<SettingsRoute>(
          ...
          routes: [
            ...
            TypedGoRoute<CustomizeHomeRoute>(path: 'customize-home'),
          ],
        ),
      ],
    ),
...
class CustomizeHomeRoute extends GoRouteData with $CustomizeHomeRoute {
  const CustomizeHomeRoute();
  @override
  Widget build(BuildContext context, GoRouterState state) =>
